'''
slection_solicitudes.py: Este script ordena las solicitudes (copiando la tabla 'solicitudes' de la BD)
por puntuación y preferencia, y asigna cada solicitud a un programa mientras queden plazas. Cuando se agoten las
plazas o si quedan menos de 2 plazas, se envía la solicitud a la lista de espera. Cada solicitud exitosa genera
una penalización de puntos al resto de solicitudes de ese usuario_id, borra del DF la solitud exitosa y reordena
el DF por puntuación y preferencia, así hasta que procesa todas las solicitudes.
'''
import pandas as pd
