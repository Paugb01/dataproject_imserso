#CÓDIGO SQL ORIGINAL DE PAU, ORDENADO PARA QUE NO DE ERROR. FALTAN CAMBIOS.
...
CREATE TABLE public.discapacidad (
    usuario_id int4 NOT NULL,
    grado_discapacidad int4 NULL,
    CONSTRAINT discapacidad_pkey PRIMARY KEY (usuario_id),
    CONSTRAINT discapacidad_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios (usuario_id)
);

CREATE TABLE public.familia (
    usuario_id int4 NOT NULL,
    tipo_familia int4 NOT NULL,
    CONSTRAINT familia_pkey PRIMARY KEY (usuario_id),
    CONSTRAINT familia_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios (usuario_id)
);